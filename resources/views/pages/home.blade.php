        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12" data-aos="zoom-in">
                    <div id="storedCarousel" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators">
                            <li class="active" data-target="#storedCarousel" data-slide-to="0"></li>
                            <li data-target="#storedCarousel" data-slide-to="1"></li>
                            <li data-target="#storedCarousel" data-slide-to="2"></li>
                        </ol>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-3 col-lg-2" data-aos="fade-up" data-aos-delay="500">
                    <a href="#" class="component-categories d-block">
                        <div class="categories-image">
                            <img src="/images/categories-toosl.svg" alt="" class="w-100" />
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="200">
                    <a href="/details.html" class="component-products d-block">
                        <div class="products-thumbnail">
                            <div class="products-image" style="
                        background-image: url('/images/product-orange-bogotta.jpg');
                    ">
                            </div>
                        </div>
