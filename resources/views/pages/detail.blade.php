            ...
            <div class="row">
                <div class="col-lg-8" data-aos="zoom-in">
                    <transition name="slide-fade" mode="out-in">
                        <img :src="photos[activePhoto].url" :key="photos[activePhoto].id" alt="Photo Gallery"
                    ...
                    <div class="row">
                        <div class="col-3 col-lg-12 mt-2 mt-lg-0" v-for="(photo, index) in photos" :key="photo.id"
                            ...
                            <a href="#" @click="changeActive(index)">
                                <img :src="photo.url" alt="Photo Thumbnail" class="w-100 thumbnail-image"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="owner">By Stefanus Dwitra</div>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <ul class="list-unstyled">
                            <li class="media">
                                <img src="/images/icon-testimonial-1.png" alt="Photo Profile Testimonial"
                            ...
                            <li class="media">
                                <img src="/images/icon-testimonial-2.png" alt="Photo Profile Testimonial"
                                    class="mr-3 rounded-circle" />
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img src="/images/icon-testimonial-3.png" alt="Photo Profile Testimonial"
                                    class="mr-3 rounded-circle" />
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">Dakimakura Wangi</h5>
